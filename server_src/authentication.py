...
def setup():
    ...
    """
    values = [('dkriezis', '8130070', '542071', 'banana', 0, 'E0 16 99 1B'), ('hayford', '5317558', '798333', 'orange', 0, '88 2B 47 E3'), 
              ("Admin", "Admin", "470236", 'puppy', 1, 'AC EC 64 68'),  ('vladap', '9466123', '670426', 'rug', 0, '63 E1 B3 31'), 
              ('muhender', '4616833', '057548', 0, 'north', 'D3 CC 5F 6D'), ('mazaheri','8150042', '113312', 'cat', 0, '06 A4 40 B7')]
    with sqlite3.connect(database) as c:
        c.execute("""CREATE TABLE IF NOT EXISTS users (username text, password text, pincode text, voice_phrase text, is_admin integer, card_id text);""")
        for tup in values:
            c.execute("""INSERT INTO users (username, password, pincode, voice_phrase, is_admin, card_id) VALUES (?,?,?,?,?,?)""", (tup[0], tup[1], tup[2], tup[3], tup[4], tup[5]))
